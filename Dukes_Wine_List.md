...
##### Truchard
 ...
 - Profile:
     - Tasting Notes: A beautiful nose of ripe plum and black cherry with hints of pomegranate, tea, and earth. The mouth is silky with flavors of red currants, rhubarb, and sweet vanilla. Firm acidity and delicate tannins focus the palate and provide a lingering finish of spice and red fruit.
         ...
         - **Sip** $\rightarrow$ silky smooth, flavors of cranberry, nutmeg, and toasty oak
...
##### Goldeneye
 ...
 - Vintage: 2019
 - Scores: 
     - *Wine Enthusiast* $\rightarrow$ 93 pts
     - *Wine Spectator* $\rightarrow$ 90 pts
     - *James Suckling* $\rightarrow$ 91 pts
 - Producer
 ...
 - Profile:
     - Tasting Notes: Showcasing the rich diversity of the Anderson Valley, this exuberant wine displays fresh, enticing aromas of juicy raspberry, simmer strawberry, and red plum, as well as hints of bramble, black tea, anise, sweet saddle leather, and a touch of salinity. On the palate, bright acidity and firm, chewy tannins converge to create a supple texture that accentuates the Bing cherry and blackberry pie flavors, with sophisticated notes of nutmeg, cardamom, and savory umami emerging on the finish to create a sumptuous and cerebral drinking experience.
         ...
         - **Body** $\rightarrow$ 
     - Food Pairing:
     - Points of Distinction:  Inaugural Vintage $\rightarrow$ 1997
 - Technical DAta
     - PH: 3.64
     - Acidity: 5.5 g/L
     - ABV: 14.2%
...
##### Bedrock 'Old Vine' / 'Ancient Vines'  Zinfadel
 ...
 - Profile:
     - Tasting Notes: Plump and zesty with lively raspberry and smoked pepper flavors that speed toward lively tannins. Drink now through 2024.
         ...
         - **Body** $\rightarrow$ 
     - Food Pairing:
     - Points of Distinction: Native yeast fermentations with a combination of punch downs and pump overs.
 - Technical DAta
     - PH: 
     - Acidity:
     - ABV: 14.4%
...
##### K Vintners 'Motor City Kitty'
 ...
 - Grapes: 100% Syrah
 - Profile:
     - Tasting Notes: Plum, Black Cherry, White Pepper, Cured Meat
         - **Duke's Flavors** $\rightarrow$ Plum, Black Cherry, White Pepper, Cured Meat
         - **Duke's Blurb** $\rightarrow$ Was just a copy of the above about his Rhone-focused label
             - **See** $\rightarrow$ 
         - **Smell** $\rightarrow$ 
         - **Sip** $\rightarrow$ 
         - **Savor** $\rightarrow$ 
...
##### The Prisoner
 ...
 - Style: Red Blend
 - Vintage: 2019
 - Scores: *Wine Enthusiast* 92pts
 - Producer 
     - Name of the Winery: The Prisoner Wine Company
     - Provenance: Our winemaking team works with a family of growers to source a diverse variety of grapes from premier vineyards throughout California. The resulting wines are interesting blends of distinct quality and character.
         - Inspired by the "Mixed Blacks"
             - First made by Italian immigrants who originally settled Napa
         - Most recognized Napa Blend
             - Zinfandel with Cabernet Sauvignon, Petite Sirah, Syrah, Charbono
 - Region: Napa, California
     - **Key Vineyards** $\rightarrow$ Bluxome Creek, Page Nord, Pastori, Pilgrim, Korte Ranch, Rogers, Solari Family Vineyard, Somerston EState, Tiedemann Ranch, York Creek
 - Grapes: Zinfandel, Cabernet Sauvignon, Petite Sirah, Syrah, Merlot
 - Profile:
     - Tasting Notes: Bright aromas of ripe raspberry, vanilla, and coconut. Flavors of fresh and dried blackberry, pomegranate, and vanilla linger harmoniously for a smooth and luscious finish.
         - **See** $\rightarrow$ Dense Red and Black Hue framed in vibrant crimson
         - **Smell** $\rightarrow$ Enticing aromas of Bing Cherry, Dark Chocolate, Clove, and Roasted Pig
         - **Sip** $\rightarrow$ Fruit Bomb
             - Persistent flavors of Ripe Raspberry, Boysenberry, Pomegranate, and Vanilla Linger
         - **Savor** $\rightarrow$ Smooth, lucious finish
         - **Body** $\rightarrow$ Soft tannins, high acid
     - Food Pairing:
     - Points of Distinction: The Prisoner was inspired by the blended wines first made by the Italian immigrants who originally settled in Napa Valley. The Prisoner is now the most recognized red blend, leading the resurgence of interesting blends by incorporating Zinfandel with the unlikely mix of Cabernet Sauvignon, Petite Sirah, Syrah, and Merlot
 - Technical DAta
     - PH: 
     - Acidity:
     - ABV:
...
##### Decoy by Duckhorn
 ...
 - Style: Merlot
 - Vintage:
 - Scores: *Wine Enthusiast* 90 pts
 - Producer
     - Name of the Winery: Duckhorn
     - Provenance:
 - Region: California
     - 60% Sonoma County, 32% Central Coast, 8% Mendocino County
 - Grapes: 80% Merlot, 18% Cabernet Sauvignon, 2% Cabernet Franc
 - Profile:
     - Tasting Notes: From its plush, refined tannins to its rustic undertones, this alluring Merlot offers juicy layers of black cherry, raspberry, and plum. On the palate, the flavors are pure and polished with a mouth-coating texture that carries the wine to a luxurious, fruit-filled finish.
         - **See** $\rightarrow$ Bright red color
         - **Smell** $\rightarrow$ Enticing aromas of blueberry, raspberry, and cassis
             - Underscored by a French oak-inspired hint of cocoa
         - **Sip** $\rightarrow$ Moderate in weight and ripeness
             - Lush and inviting with layers of luxurious fruit
         - **Savor** $\rightarrow$ Silky tannins carry wine to long juicy finish
             - Balanced acidity
             - Lively acidity adds poise and structure
         - **Body** $\rightarrow$ Graceful and velvety
     ...
     - Food Pairing:
     - Points of Distinction: Inaugural Vintage $\rightarrow$ 2008
 - Technical DAta
     - PH: 3.55
     - Acidity: 0.63 g/L
     - ABV: 13.9%
...
##### Charles Smith 'Substance'
 ...
 - Vintage: 2019
 - Scores:
     - *James Suckling* $\rightarrow$ 92 pts
     - *Jeb Dunnuck* $\rightarrow$ 92 pts
 - Producer
     - Name of the Winery: House of Smith
     - Provenance: The 2019 vintage was on the cooler side as it started slow with later-than-usual bud break and continued on to be fairly moderate throughout the year. Some vineyards had issues with an October freeze a bit earlier than usual, but our high-elevation vineyards have great air drainage which allows us to extend the growing seqason late into October without freeze. This yielded fantastic ripening and some awesome wines with incredible balance and character. Overall, we are excited about the wine produced in 2019, which has brought us more finesse, incredible flavors and lovely balance.
 - Region: Columbia Valley
     - **Vineyards** $\rightarrow$ Goose Ridge, Painted Hills, Badger Mountain, Shaw, Sportsfisher, Coyote
 - Grapes: 100% Cabernet Sauvignon
 - Profile:
     - Tasting Notes: Classic from the get-go. Black cassis, pipe tobacco, and black cherry saturates the mouth. Followed by forest floor, dark plum, and pencil lead. Great density and a tremendous finesse-filled finish which one has to repeat. . . A CLASSIC!
         ...
         - **Body** $\rightarrow$
     - Food Pairing:
     - Points of Distinction: **Production** $\rightarrow$ 4.5 tons per acre, native yeast, 100% whole berry fermentation, 41 days on skins
 - Technical DAta
     - PH: 3.78
     - Acidity: 5.9 g/L
     - ABV: 14.05%
...
##### Frank Family
 ...
 - Vintage: 2018
 - Scores:
     - *Wine Advocate* $\rightarrow$ 91 pts
     - *Vinous* $\rightarrow$ 91 pts
 - Producer
     - Name of the Winery: Frank Family Vineyards
     - Provenance: Mr Frank was a Disney Exec who got a taste for French wines while opening Disney Paris
         - Their vineyards were named after Frank Brothers children
         - **Winemaker Notes** $\rightarrow$ Our goal is to make a complete, balanced wine. Cabernet Sauvignon is a great grape, it's the king of Napa Valley after all. But it can benefit from the addition of other grapes, like Merlot which adds some softness. Together you get the whole package.
 - Region: Napa Valley, CA
     - **Sourcing** $\rightarrow$ Sourced primarily from our family-owned S&J Vineyard in Napa's Capell Valley and our Benjamin Bineyard located on the valley floor in the heart of Rutherford. Additional vineyard sources include neighboring Quarry Vineyard and Round Pond Estate both in Rutherford as well as Delouise and Shooting Star Vineyard located in Napa Valley.
 - Grapes: 96% Cabernet Sauvignon, 2% Petit Verdot, 2% Merlot
     - Bordeaux Blend
         - Meritage is the American term for Bordeaux
         - French word "meritage" to explain American Style
 - Profile:
     - Tasting Notes: A beautiful wine from a near-perfect vintage, this robust Cabernet Sauvignon shows balance and complexity - a blend of dark berry, generous oak notes, clove, and nutmeg. This is a supple and complex, full-bodied in style, with a punch of power, ripeness, and elegance from start to finish.
         - Predominantly fruit
         ...
         - Black Currant
             - Tell-tale for a cab
         - Smooth
         - **See** $\rightarrow$ Rich opaque ruby
         - **Smell** $\rightarrow$ Rich Aromas of creme de cassis, fresh espresso, vanilla bean, and ripe blackberry
             - notes of cedar
         - **Sip** $\rightarrow$ Flavors of blackberry, raspberry, black cherry, cocoa powder
             - spiced fruit flavors lingering endlessly
         - **Savor** $\rightarrow$ Soft yet firm tannic structure
             - finish is long and expressive
         - **Body** $\rightarrow$ Medium-to-full and firm in the mouth
     - Food Pairing: subtly gripping tannins that beg for grilled meat
     - Points of Distinction: 
 - Technical DAta
     - PH: 3.64
...
##### Cliff Lede
 ...
 - Style: Cabernet Sauvignon
 - Vintage: 2019
 - Scores: *Wine Advocate* 93 pts (2016)
 - Producer
     - Name of the Winery: Cliff Lede Vineyards
         - **Address** $\rightarrow$ 1473 Yountville Cross Road  
             Yountville, CA 94599-9471
         - **Telephone** $\rightarrow$ (707)944-8642
         - **Website** $\rightarrow$ cliffledevineyards.com
     - Provenance: Established in 2002, Cliff Lede Vineyards encompasses sixty acres in the famed Stags Leap District. Founder Cliff Lede, Director of Vineyard Operations Allison Wilson, and Director of Winemaking Christopher Tynan have come together to form an unrivaled team, making the most of this remarkable property.
         - Vineyards are named after Rock & Roll songs
         - **Vintage** $\rightarrow$ The 2019 vinttage was a magnificent year for Napa Valley. A frost-free and uniform bud break was followed by a cool wet spring that included three inches of rain in May. Luckily, the rain didn't affect set and the weather turned warm and sunny for the duration of spring. Welcome warm nights in June, July, and August caught maturation back on schedule. Summer conditions were moderate, with warm days and cool nights, ideal for slow and steady grape maturation. The wine shows exceptional balance with concentrated, ripe fruit complemented by bright acidity and supple, yet intense, structure. Optimal ripeness was achieved thanks to an early autumn of consistently warm, but not hot, days. The pristine ripening conditions allowed for very intense fruit flavor concentrations.
 - Region: Stags Leap District
     - **Vineyards** $\rightarrow$ The fruit was sourced from the hillside terrace of our Poetry Vineyard, our Twin Peaks Vineyard estate surrounding the winery, and a few neighboring vineyards in the Stags Leap District. The wine is composed of small lots from our best blocks, representing a diverse range of carefully selected clones and rootstocks. From Poetry's exposed, rocky terraces boasting volcanic origins, to the ancient riverbed alluvial soils of Twin Peaks, the breadth of contributing sites translates into a wine of impressive complexity. 
 - Grapes: 82% Cabernet Sauvignon, 8% Merlot, 7% Cabernet Franc, 4% Petit Verdot
     - **Winemaking** $\rightarrow$ Grapes were picked in the darkness of the early morning hours. The freshly-harvested fruit immediately underwent rigorous selection by our three-tiered sorting process, which included our cutting-edge optical sorter. Whole berries were gently delivered by gravity to tank using our crane system, minimuzing disruption of berry integrity. Cold soaks lasted approximately seven days, and fermentations were managed via a combination of *délestage*, pumpovers, and punchdowns. Extended maceration ranging from four to five weeks fine-tuned our tannin profiles, allowing us to perfect mouth feel and wine complexity.
 - Profile:
     - Tasting Notes: "The essence of our proud Stags Leap District terroir in a glass, the 2019 vintage produced a delicious wine of purity, warmth, and grace. Built on a foundation of lush cassis, blackberry, and dark cherry aromas, this long and full-boduied wine is apportioned with a perfume of cardamom, clove, and ancho chile. Graphite, chocolate cake, crushed mulberries, and grilled steak notes make an appearance along the way and add to a long and complex finish" -- *Christopher Tynan, Director of Winemaking*
         - **See** $\rightarrow$ Inky black 2016 is a lithe and tempting elixer that dazzles the senses
         - **Smell** $\rightarrow$ Fully integrated nose of fresh red and black currants, wild blackberries, and a perfumed bouquet of violets and lavender, unsmoked cigars and tilled soil
         - **Sip** $\rightarrow$ Dense fruit
             - Spice notes of smoked cardamom, anise, and cumin dance among the fig paste and luxardo cherry flavors
         - **Savor** $\rightarrow$ Opulent finish crescendos in a wave of subtle tannins
             - Long, Earthy finish
         - **Body** $\rightarrow$ Firm backbone of grainy tannins
...
##### Silver Oak
 ...
 - Scores:
 - Producer
     - Name of the Winery: Silver Oak
         - **Addresss** $\rightarrow$ 
         - **Telephone** $\rightarrow$ (800)273-8809
         - **Website** $\rightarrow$ silveroak.com
     - Provenance: LEED Platinum and Living Building-certified Silver Oak winery
         - **Vintage Description** $\rightarrow$ Mother Nature made a memorable impression on the 2017 vintage. In January we welcomed epic winter rains that brought an end to the enduring five-year drought. The generous precipitation filled our water tables and woke up the vines. After an average bud break, prolific shoot and vegetation growth early in the season required close observation and much weed control and leafing to open the dense canopies. Bloom proceeded at a steady pace and set us up for a healthy crop size. In June and July, three extended heat events tested our vineyard team and culminated with high temperatures around Labor Day. While the hot weather kick-started harvest on September 4, our irrigation management and cooler, foggy mornings allowed the vines to recover and resume their trajectory towards full aromatic and phsyiological ripeness. We were happy to see sugars and acids at normal levels. The pace of harvest was steady and we had thankfully finished picking before the wildfires started on the night of October 8. While 2017 certainly presented its share of challenges, it was also the jubilant, inaugural vintage for our new, state-of-the-art facility we had been planning, designing, and building since we purchased the Alexander Valley property in 2012.
 - Region: Alexander Valley, CA
 - Grapes: 95.5% Cabernet Sauvignon, 3.6% Merlot, 0.5% Cabernet Franc, 0.3% Petit Verdot, 0.1% Malbec
 - Profile:
     - Tasting Notes: Ruby in color with a purple rim. Warm and inviting, it has notes of red currant, cassis, ripe plum, cardamom, and toffee. There's depth and weight on the palate -- a harmonious intensity. This wine has a long and beautiful finish, and its fine tannins will provide drinking pleasure through 2043 with proper cellaring.
         - **See** $\rightarrow$ Garnet color with ruby red rim and bluis tint
         - **Smell** $\rightarrow$ Alluring nose of chocolate covered strawberries, vanilla, nutmeg, truffle, and sage
         - **Sip** $\rightarrow$ Broad, yet delicate entry and offers cranberry flavors, vanilla, & leather
             - complemented by raspberry and pluot (Hybrid between Japanese Plum and Apricot) with savory black olive characters
             - Wood is prominent
             - semi-fruity
         - **Savor** $\rightarrow$ Long finish with silky tannins
             - Excellent length
         - **Body** $\rightarrow$ Full-bodied with polished, smart tannins
     - Food Pairing:
     - Points of Distinction: 
 - Technical DAta
     - PH: 
...
##### O'Shaugnessy
 ...
 - Scores:
 - Producer
     - Name of the Winery: O'Shaughnessy
         - **Address** $\rightarrow$ 
         - **Telephone** $\rightarrow$
         - **Website** $\rightarrow$
     - Provenance:
 ...
 - Grapes:
 - Profile:
     - Tasting Notes: Bold, medium-high tannins, medium to low dryness, Medium-plus acidic
         - Oak, vanilla, tobacco
         - Dark fruit, blackberry
         - Leather, earthy, smoke (much less than the other two descriptions)
         - **See** $\rightarrow$ 
         - **Smell** $\rightarrow$ 
         - **Sip** $\rightarrow$ 
         - **Savor** $\rightarrow$ 
